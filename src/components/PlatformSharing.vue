...
const contentLibrary = {
  ...
  'jiezishu': [
    {
      id: 201,
      content: '<strong>【原文】</strong><br/>山不在高，有仙则名。水不在深，有龙则灵。斯是陋室，惟吾德馨。苔痕上阶绿，草色入帘青。谈笑有鸿儒，往来无白丁。可以调素琴，阅金经。无丝竹之乱耳，无案牍之劳形。南阳诸葛庐，西蜀子云亭。孔子云：何陋之有？<br/><br/><strong>【作品背景】</strong><br/>《陋室铭》是唐代诗人刘禹锡所作的一篇托物言志的铭文。作者曾在监察御史任上得罪了当权者，被贬至安徽和州当通判。知县看人下菜碟，多次刁难，把刘禹锡的住处从三间房换到一间半，最后仅给一间陋室。刘禹锡遂愤然写下此铭，表明自己高洁傲岸的节操和安贫乐道的情趣。<br/><br/><strong>【重点词语】</strong><br/>• 在：在于<br/>• 名：出名，著名<br/>• 灵：灵异，神奇<br/>• 斯：这<br/>• 陋室：简陋的房屋<br/>• 惟：只<br/>• 德馨：品德高尚<br/>• 鸿儒：博学的人<br/>• 白丁：没有学问的人<br/>• 调：弹奏<br/>• 素琴：不加装饰的琴<br/>• 金经：佛经<br/>• 丝竹：泛指奏乐的声音<br/>• 案牍：官府的公文',
      type: '文章整体讲解',
      year: '2025',
      answer: '文章通过描写陋室的不陋，表达了作者高洁傲岸的节操和安贫乐道的情趣。<br/><br/>文章开篇以"山"和"水"作类比，引出"陋室"因主人品德高尚而不陋的主旨。接着描写陋室的环境、交往和生活：环境清幽（苔痕绿、草色青），交往高雅（鸿儒来往、无白丁），生活情趣（调素琴、阅金经、无丝竹、无案牍）。最后引用诸葛亮的草庐和扬雄的玄亭为例，并引孔子的话收束全文，点明"陋室"因主人之德而不陋的主题。',
      analysis: '1. 托物言志：以陋室为依托，表达作者不慕荣利、安贫乐道的高尚情操和不与世俗同流合污的品格。<br/><br/>2. 类比开篇：用"山"和"水"类比"陋室"，以有仙之山、有龙之水不在高深为名，引出陋室因主人品德高尚而不陋，开篇点题。<br/><br/>3. 层次清晰：由外到内，由景到人，由古到今，层层深入，最后以孔子之言收束，水到渠成。<br/><br/>4. 反衬手法：以"陋"衬"不陋"，表面写陋室之陋，实际突出主人品德之高。',
      showAnalysis: false
    },
    {
      id: 202,
      content: '<strong>【名句赏析】</strong><br/>"斯是陋室，惟吾德馨"<br/><br/><strong>【句意理解】</strong><br/>这是简陋的房子，只是我的品德高尚（就不感到简陋了）。',
      type: '名句赏析',
      year: '2025',
      answer: '这是全文的主旨句，点明陋室不陋的根本原因。<br/><br/>"斯是陋室"承认住处简陋的客观事实，"惟吾德馨"笔锋一转，强调主人品德高尚。"馨"本指香气远播，这里比喻品德的美好。作者认为，一个人品德的高尚与否，与居室的简陋无关。<br/><br/>这句话体现了作者不以物质条件论高下，而以精神品格为追求的高尚情操，也是对那些以貌取人、势利小人的有力回击。',
      analysis: '1. 对比鲜明："陋"与"德馨"形成对比，突出精神品格的重要性。<br/><br/>2. 点明主旨：全文围绕这句话展开，后文所写环境、交往、生活都是"德馨"的具体体现。<br/><br/>3. 自我表白：表达了作者坚守节操、不随波逐流的人生态度。',
      showAnalysis: false
    },
    {
      id: 203,
      content: '<strong>【名句赏析】</strong><br/>"苔痕上阶绿，草色入帘青"<br/><br/><strong>【句意理解】</strong><br/>苔藓碧绿，长到台阶上；草色青葱，映入帘中。',
      type: '名句赏析',
      year: '2025',
      answer: '这两句描写陋室的环境，是全文最富诗意的句子。<br/><br/>"苔痕上阶绿"写台阶上长满青苔，说明居处清幽，少有人来，主人不慕荣利。"草色入帘青"写窗外草色青青，映入室内，环境清新自然。<br/><br/>两句对偶工整，色彩鲜明（绿、青），富有生机。虽写陋室环境简陋、清冷，却透出一种恬淡、清幽、充满自然生机的意境，暗示主人安贫乐道、淡泊名利的情怀。',
      analysis: '1. 以景衬情：用清幽的环境烘托主人恬淡的心境。<br/><br/>2. 对偶工整："苔痕上阶绿"对"草色入帘青"，结构相同，音韵和谐。<br/><br/>3. 动静结合："上"、"入"化静为动，使画面富有生机。<br/><br/>4. 色彩鲜明：绿、青二色，清新自然，充满生机。',
      showAnalysis: false
    },
    {
      id: 204,
      content: '<strong>【重点句段】</strong><br/>"谈笑有鸿儒，往来无白丁"<br/><br/><strong>【句意理解】</strong><br/>到这里谈笑的都是博学的人，来往的没有粗俗的人。',
      type: '重点句段讲解',
      year: '2025',
      answer: '这两句写陋室中的交往，突出主人的精神生活。<br/><br/>"鸿儒"指博学之士，"白丁"指没有学问的人。与鸿儒交谈，能够互相切磋学问，提升思想境界；不与白丁往来，能够保持心境的清净。<br/><br/>这两句从侧面烘托主人的学识与品位，表明主人虽身处陋室，但精神世界丰富，志趣高雅。也体现了作者择友的标准：重视精神交流，而非物质攀比。',
      analysis: '1. 对比手法："有"与"无"、"鸿儒"与"白丁"形成对比，突出交往的高雅。<br/><br/>2. 侧面烘托：通过写来往之人的学识，反衬主人的品格和学问。<br/><br/>3. 精神追求：体现了作者重视精神生活胜过物质享受的价值观。',
      showAnalysis: false
    },
    {
      id: 205,
      content: '<strong>【写作特色】</strong><br/>铭文体裁，托物言志',
      type: '写作特色分析',
      year: '2025',
      answer: '1. 铭文体裁：铭是古代刻在器物上用来警戒自己或称述功德的文字，后来成为一种文体。这种文体一般用韵，句式较为整齐，便于诵读和记忆。<br/><br/>2. 托物言志：借陋室来表达自己高洁傲岸的节操和安贫乐道的情趣。表面写陋室，实际写人品。<br/><br/>3. 类比起兴：开头用山、水作类比，自然引出陋室的话题，使文章显得委婉含蓄。<br/><br/>4. 对偶工整：全文多处使用对偶，如"苔痕上阶绿，草色入帘青"、"谈笑有鸿儒，往来无白丁"等，音韵和谐，朗朗上口。',
      analysis: '1. 正反对比：通过"陋"与"不陋"的对比，突出主题。<br/><br/>2. 引用典故：引用诸葛亮的草庐、扬雄的玄亭以及孔子的话，增强说服力，使文章更有文化底蕴。<br/><br/>3. 语言精练：全文仅81字，却内容丰富，意境深远，堪称铭文中的经典之作。',
      showAnalysis: false
    },
    {
      id: 206,
      content: '<strong>【思想内涵】</strong><br/>安贫乐道的君子之风',
      type: '思想内涵探究',
      year: '2025',
      answer: '《陋室铭》体现了中国传统文化中君子的理想人格：<br/><br/>1. 安贫乐道：不以物质条件的优劣改变自己的志向和操守，在简陋的环境中依然保持高尚的品德和精神追求。<br/><br/>2. 洁身自好：不与世俗同流合污，保持自己的独立人格和高尚情操。"谈笑有鸿儒，往来无白丁"体现了这种择友标准。<br/><br/>3. 淡泊名利：不追求荣华富贵，专注于精神生活。"无丝竹之乱耳，无案牍之劳形"表明了对世俗享乐和官场俗务的超脱。<br/><br/>4. 以德为本：认为品德修养比物质享受更重要，"惟吾德馨"点明这一主旨。',
      analysis: '1. 作者借陋室表明心志，实际是对那些以貌取人、趋炎附势之人的讽刺和批判。<br/><br/>2. 这种精神对今天仍有启示意义：在物质生活日益丰富的今天，我们更应该注重精神品格的修养，不被物质所累，保持内心的高尚和纯净。<br/><br/>3. 体现了中国文人"穷则独善其身"的传统，即使身处逆境，也要保持人格的独立和精神的高洁。',
      showAnalysis: false
    }
  ],
