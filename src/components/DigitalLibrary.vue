...
const contentLibrary = {
  ...
  'jiezishu': [
    {
      id: 201,
      content: '<strong>【原文】</strong><br/>山不在高，有仙则名。水不在深，有龙则灵。斯是陋室，惟吾德馨。苔痕上阶绿，草色入帘青。谈笑有鸿儒，往来无白丁。可以调素琴，阅金经。无丝竹之乱耳，无案牍之劳形。南阳诸葛庐，西蜀子云亭。孔子云：何陋之有？<br/><br/><strong>【作者简介】</strong><br/>刘禹锡（772-842），字梦得，唐代文学家、哲学家。因参与政治革新失败被贬，写下此文表达自己安贫乐道的生活态度和高洁傲岸的情操。<br/><br/><strong>【重点字词】</strong><br/>• 在：在于<br/>• 名：出名，著名<br/>• 灵：灵异，神奇<br/>• 斯：这<br/>• 德馨：品德高尚<br/>• 鸿儒：博学的人<br/>• 白丁：没有学问的人<br/>• 丝竹：指奏乐的声音<br/>• 案牍：官府的公文',
      type: '文章整体讲解',
      year: '2025',
      answer: '这是一篇托物言志的铭文。作者通过对陋室的描写，表达了自己安贫乐道、不慕名利的生活态度和高洁傲岸的节操。<br/><br/>文章开篇以山水起兴，点明"德馨"才是陋室不陋的根本原因。接着从环境、交往、生活三个方面描写陋室的不凡：环境清幽雅致，交往皆鸿儒，生活充实高雅。最后以诸葛亮、扬雄自比，引孔子之言作结，突出陋室因主人品德高尚而不陋的主旨。',
      analysis: '1. 托物言志：借陋室这一具体事物，表达作者安贫乐道、洁身自好的节操和情趣。<br/><br/>2. 对比衬托：以"山""水"起兴，以"诸葛庐""子云亭"类比，衬托陋室不陋。<br/><br/>3. 虚实结合：既写陋室的客观环境（苔痕、草色），又写主观感受（谈笑、调琴），虚实相生。',
      showAnalysis: false
    },
    {
      id: 202,
      content: '<strong>【名句赏析】</strong><br/>"斯是陋室，惟吾德馨"<br/><br/><strong>【句意理解】</strong><br/>这是简陋的屋子，只是我的品德高尚（就不感到简陋了）。',
      type: '名句赏析',
      year: '2025',
      answer: '这是全文的主旨句，开门见山地点明了陋室不陋的根本原因。<br/><br/>"斯是陋室"承认了居室的简陋，"惟吾德馨"则强调主人品德的高尚。一个"惟"字，突出了品德的重要性，表明只要品德高尚，陋室也就不陋了。<br/><br/>这体现了作者不以物质条件的优劣来衡量生活质量，而是注重精神追求和道德修养的人生态度。',
      analysis: '1. 对比手法："陋室"与"德馨"形成对比，突出品德的重要性。<br/><br/>2. 全文核心：这句话统领全文，后文所写都是围绕"德馨"展开。<br/><br/>3. 价值观念：体现了中国传统文化中"君子固穷"、重德轻物的价值观。',
      showAnalysis: false
    },
    {
      id: 203,
      content: '<strong>【名句赏析】</strong><br/>"苔痕上阶绿，草色入帘青"<br/><br/><strong>【句意理解】</strong><br/>苔藓爬上台阶染出一片碧绿，草色映入竹帘映出青青之色。',
      type: '名句赏析',
      year: '2025',
      answer: '这两句描写陋室周围环境的清幽雅致。<br/><br/>"苔痕上阶绿"写台阶上长满青苔，说明这里人迹罕至，十分幽静。"草色入帘青"写窗外草色青青，映入室内，环境清新自然。<br/><br/>两句对偶工整，色彩鲜明，动静结合（"上"、"入"二字化静为动），营造出清幽淡雅的意境，暗示主人超凡脱俗、不与世俗同流的高洁品格。',
      analysis: '1. 对偶工整："苔痕上阶绿"对"草色入帘青"，结构相同，色彩和谐。<br/><br/>2. 以景衬人：通过清幽的环境描写，衬托主人的高雅志趣。<br/><br/>3. 动词传神："上"、"入"二字赋予景物以生命，增强了画面的动态美。<br/><br/>4. 色彩鲜明：两个"绿"（碧绿）和"青"字，突出了环境的清新自然。',
      showAnalysis: false
    },
    {
      id: 204,
      content: '<strong>【重点句段】</strong><br/>"谈笑有鸿儒，往来无白丁"<br/><br/><strong>【句意理解】</strong><br/>谈笑的都是博学的人，来往的没有粗俗的人。',
      type: '重点句段讲解',
      year: '2025',
      answer: '这两句从交往方面写陋室主人的不凡。<br/><br/>"谈笑有鸿儒"说明主人交往的都是学识渊博的人，谈笑之间都是高雅的话题。"往来无白丁"说明来往的没有没有学问的粗俗之人。<br/><br/>通过"有"与"无"的对比，突出了主人交友的高雅和生活的充实。这也从侧面反映出主人自己就是一位学识渊博、品德高尚的鸿儒，所谓"物以类聚，人以群分"。',
      analysis: '1. 正反对比："有鸿儒"与"无白丁"形成对比，强调交友的选择性和高雅性。<br/><br/>2. 侧面烘托：通过写交往对象，侧面烘托主人的学识和品格。<br/><br/>3. 以人衬室：说明虽然居室简陋，但精神生活丰富充实，进一步突出"惟吾德馨"的主旨。',
      showAnalysis: false
    },
    {
      id: 205,
      content: '<strong>【写作手法】</strong><br/>"可以调素琴，阅金经。无丝竹之乱耳，无案牍之劳形"<br/><br/><strong>【句意理解】</strong><br/>可以弹奏不加装饰的琴，阅读佛经。没有嘈杂的音乐扰乱耳朵，没有官府的公文劳累身心。',
      type: '写作手法分析',
      year: '2025',
      answer: '这几句从生活情趣方面写陋室主人生活的高雅和闲适。<br/><br/>"调素琴，阅金经"写主人的生活内容：弹琴、读经，都是高雅的精神活动。"素琴"即不加装饰的琴，体现了主人不慕华丽、追求本真的品格。<br/><br/>"无丝竹之乱耳，无案牍之劳形"则从反面写，没有嘈杂的音乐（丝竹指管弦乐器），没有繁琐的公务。通过"无"字的反复使用，突出了生活的宁静悠闲和精神的自由超脱。',
      analysis: '1. 正反结合：先正面写生活的高雅（调琴、阅经），再从反面写没有世俗的烦扰（无丝竹、无案牍）。<br/><br/>2. 对比手法："素琴""金经"与"丝竹""案牍"对比，突出主人追求精神世界的充实，摒弃世俗的喧嚣和功利。<br/><br/>3. 表达志趣：这几句最能体现主人安贫乐道、淡泊名利的生活态度和精神追求。',
      showAnalysis: false
    },
    {
      id: 206,
      content: '<strong>【思想内涵】</strong><br/>"南阳诸葛庐，西蜀子云亭。孔子云：何陋之有？"<br/><br/><strong>【句意理解】</strong><br/>南阳有诸葛亮的草庐，西蜀有扬雄的亭子。孔子说："有什么简陋的呢？"',
      type: '思想内涵探究',
      year: '2025',
      answer: '文章结尾以诸葛亮的草庐、扬雄的亭子类比自己的陋室，表明自己也要像他们一样，不因居室简陋而改变志向。<br/><br/>诸葛亮躬耕南阳时住草庐，后成为一代名相；扬雄家境贫寒，住在简陋的亭子里，却成为著名学者。作者以二人自比，表达了自己虽身处逆境（被贬）却志向不改的坚定信念。<br/><br/>最后引用孔子的话"何陋之有"，进一步点明主旨：只要品德高尚，陋室又有什么简陋的呢？照应开头"惟吾德馨"，使全文结构严谨，主旨鲜明。',
      analysis: '1. 类比手法：以诸葛庐、子云亭类比陋室，以古代名人自比，表明自己的志向和抱负。<br/><br/>2. 引用论证：引用孔子的话作结，既增强了说服力，又含蓄地表达了自己不以物质条件论生活品质的人生态度。<br/><br/>3. 思想内涵：全文体现了儒家"君子固穷"的思想和道家"清静无为"的理念，是中国传统文化中安贫乐道、淡泊名利精神的典范。',
      showAnalysis: false
    }
  ],
