<template>
  <div class="app-container">
    <Header 
      :show-tabs="!showPaperCenter && currentLeftMenu >= 2 && currentLeftMenu <= 6"
    ...
    <div class="main-wrapper">
      ...
      <div class="content-wrapper" :class="{ 'nav-collapsed': leftNavCollapsed }">
        ...
        <!-- 正常菜单内容 -->
        <template v-else>
          <PlatformSharing v-if="currentLeftMenu === 0" ref="platformSharingRef" @goto-paper-center="handleGotoPaperCenter" />
...
const handleMenuChange = (menuIndex) => {
  ...
  if (currentLeftMenu.value === menuIndex) {
    // 如果是备考方案，重置其状态
    if (menuIndex === 0 && platformSharingRef.value) {
